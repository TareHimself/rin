...
class BaseRecipe(ConanFile):
    ...
    def config_options(self):
        self.is_release = self.settings.build_type == "Release"  # type: ignore
    ...
    def layout(self):
        ...
        self.folders.build_folder_vars = ["settings.build_type"]  # type: ignore
    ...
    def generate(self):
        ...
        with open(os.path.join(os.getcwd(), "CMakePresets.json"), "r+") as f:
            ...
            jsonData["configurePresets"][0]["displayName"] = (
                f"'Rin-{configuration}' config"
            )
            jsonData["configurePresets"][0]["description"] = (
                "Configure made by conan modified by Rin"
            )
