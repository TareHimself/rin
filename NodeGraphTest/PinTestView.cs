...
public class PinTestView : SingleSlotCompositeView, IGraphPinView
{
    ...
    protected Vector2 GetPinOffset()
    {
        ...
        var offsetX = PinType == PinType.Input
            ? NodeGraphConstants.PinPadding
            : _contentXSize + NodeGraphConstants.PinPadding;
    ...
    protected void CollectPin(in Matrix4x4 transform, CommandList commands)
    {
        ...
        _pinPosition = new Vector2(0).Transform(Matrix4x4.Identity
            .Translate(GetPinOffset() + new Vector2(NodeGraphConstants.PinRadius)).ChildOf(transform));
        // commands.AddRect(
