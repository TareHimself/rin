    ...
    FrozenDictionary<uint, DescriptorSet>? globalSets = null) : IExecutionContext
{
    ...
    public IExecutionContext StencilFillOp()
    {
        vkCmdSetStencilWriteMask(CommandBuffer, VkStencilFaceFlags.VK_STENCIL_FACE_FRONT_AND_BACK, 0xFF);
        vkCmdSetStencilCompareMask(CommandBuffer, VkStencilFaceFlags.VK_STENCIL_FACE_FRONT_AND_BACK, 0xFF);
        vkCmdSetStencilOp(CommandBuffer, VkStencilFaceFlags.VK_STENCIL_FACE_FRONT_BIT,
            VkStencilOp.VK_STENCIL_OP_KEEP, VkStencilOp.VK_STENCIL_OP_INCREMENT_AND_WRAP,
            VkStencilOp.VK_STENCIL_OP_KEEP, VkCompareOp.VK_COMPARE_OP_ALWAYS);
        vkCmdSetStencilOp(CommandBuffer, VkStencilFaceFlags.VK_STENCIL_FACE_BACK_BIT,
            VkStencilOp.VK_STENCIL_OP_KEEP, VkStencilOp.VK_STENCIL_OP_DECREMENT_AND_WRAP,
            VkStencilOp.VK_STENCIL_OP_KEEP, VkCompareOp.VK_COMPARE_OP_ALWAYS);
        return this;
    }

    public IExecutionContext StencilCoverOp()
    {
        vkCmdSetStencilWriteMask(CommandBuffer, StencilFaceFlags, 0xFF);
        vkCmdSetStencilCompareMask(CommandBuffer, StencilFaceFlags, 0xFF);
        vkCmdSetStencilReference(CommandBuffer, StencilFaceFlags, 0);
        vkCmdSetStencilOp(CommandBuffer, StencilFaceFlags, VkStencilOp.VK_STENCIL_OP_KEEP,
            VkStencilOp.VK_STENCIL_OP_ZERO, VkStencilOp.VK_STENCIL_OP_KEEP,
            VkCompareOp.VK_COMPARE_OP_NOT_EQUAL);
        return this;
    }

    public IExecutionContext StencilPassThrough()
    {
        vkCmdSetStencilOp(CommandBuffer, StencilFaceFlags, VkStencilOp.VK_STENCIL_OP_KEEP,
            VkStencilOp.VK_STENCIL_OP_KEEP, VkStencilOp.VK_STENCIL_OP_KEEP,
            VkCompareOp.VK_COMPARE_OP_ALWAYS);
