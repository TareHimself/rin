...
{
    private readonly CompiledComputeShader _shader;

    public VulkanComputeBindContext(CompiledComputeShader shader, VulkanExecutionContext executionContext) : base(
        executionContext)
    {
        _shader = shader;
    }
