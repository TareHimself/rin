...
public class InitWorldPass : IPass
{
    ...
    public void Configure(IGraphConfig config)
    {
        ...
        _renderContext.GBufferImage0 =
            config.CreateTexture(_renderContext.Extent, ImageFormat.RGBA32, ImageLayout.ShaderAccess);
        _renderContext.GBufferImage1 =
            config.CreateTexture(_renderContext.Extent, ImageFormat.RGBA32, ImageLayout.ShaderAccess);
        _renderContext.GBufferImage2 =
            config.CreateTexture(_renderContext.Extent, ImageFormat.RGBA32, ImageLayout.ShaderAccess);
        _renderContext.GBufferImage3 =
            config.CreateTexture(_renderContext.Extent, ImageFormat.RGBA32, ImageLayout.ShaderAccess);
        _renderContext.DepthImageId =
            config.CreateTexture(_renderContext.Extent, ImageFormat.Depth, ImageLayout.ShaderAccess);
    }
    ...
    public void Execute(ICompiledGraph graph, IExecutionContext ctx)
    {
        ...
        var gBuffer3 = graph.GetImageOrException(_renderContext.GBufferImage3);
