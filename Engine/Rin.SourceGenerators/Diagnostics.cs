...
internal static class Diagnostics
{
    ...
    internal static class Providers
    {
        public static readonly DiagnosticDescriptor ContainingTypeMustBePartial = new(
            id: "RIN00018",
            title: "Containing type must be partial",
            messageFormat: "Type '{0}' containing resolved property '{1}' must be declared partial so generated code can extend it",
            category: "Rin.Core",
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true);
        ...
        public static readonly DiagnosticDescriptor PropertyMustBePartial = new(
            id: "RIN00019",
            title: "Resolved property must be partial",
            messageFormat: "Property '{0}' must be declared partial so the generator can provide its implementation",
            category: "Rin.Core",
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true);
        ...
        public static readonly DiagnosticDescriptor PropertyMustHaveGetter = new(
            id: "RIN00020",
            title: "Resolved property must declare a getter",
            messageFormat: "Property '{0}' must declare a bodyless getter (and optionally a bodyless setter) - the generator provides the implementation",
            category: "Rin.Core",
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true);
        ...
        public static readonly DiagnosticDescriptor InvalidPropertyType = new(
            id: "RIN00021",
            title: "Invalid resolved property type",
            messageFormat: "Property '{0}' must be a reference type - '{1}' cannot be resolved from the provider",
            category: "Rin.Core",
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true);
        ...
        public static readonly DiagnosticDescriptor PropertyMustNotBeStatic = new(
            id: "RIN00022",
            title: "Resolved property must not be static",
            messageFormat: "Property '{0}' must be an instance property - static resolved properties are not supported",
            category: "Rin.Core",
            defaultSeverity: DiagnosticSeverity.Error,
            isEnabledByDefault: true);
    }
