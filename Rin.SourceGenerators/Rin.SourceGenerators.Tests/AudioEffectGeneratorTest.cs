...
public class AudioEffectGeneratorTests
{
...
";
    ...
    public void GenerateReportMethod()
    {
         ...
         var compilation = CSharpCompilation.Create(nameof(AudioEffectGeneratorTests),
             new[] { CSharpSyntaxTree.ParseText(VectorClassText) },
             new[]
             {
                 // To support 'System.Attribute' inheritance, add reference to 'System.Private.CoreLib'.
                 MetadataReference.CreateFromFile(typeof(object).Assembly.Location),
                 MetadataReference.CreateFromFile(typeof(AudioEffectContext).Assembly.Location),
