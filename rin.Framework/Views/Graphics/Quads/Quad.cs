...
public partial struct Quad() // : ICloneable<Quad>
{
    ...
    public static Quad QuadraticCurve(Vector2 a, Vector2 control, Vector2 b,float thickness = 2.0f, Vector4? color = null)
    {
        const float feather = 3.0f;
    ...
    public static Quad CubicCurve(Vector2 a, Vector2 controlA, Vector2 b, Vector2 controlB,float thickness = 2.0f, Vector4? color = null)
    {
        const float feather = 3.0f;
