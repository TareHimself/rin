...
public class ListSlot(List? container = null) : CompositeViewSlot(container)
{
...
/// </summary>
public class List(Axis axis) : CompositeView
{
    ...
    protected virtual float GetSlotCrossAxisSize(CompositeViewSlot slot, float crossAxisAvailableSize)
    {
    ...
    protected override CompositeViewSlot MakeSlot(View view) => new ListSlot(this)
    {
        Child = view,
    };
}