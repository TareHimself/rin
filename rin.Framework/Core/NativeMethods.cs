...
internal static partial class NativeMethods
{
    ...
    public static partial void NativeSelectFile([MarshalAs(UnmanagedType.BStr)] string title,
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial void NativeSelectPath([MarshalAs(UnmanagedType.BStr)] string title,
