...
public static class MathExtensions
{
    ...
    public static Vector2 FiniteOr(this Vector2 val, float x = 0.0f,float y = 0.0f) => new (float.IsFinite(val.X) ? val.X : x,float.IsFinite(val.Y) ? val.Y : y);
    
    public static Vector2 FiniteOr(this Vector2 val,Vector2 other) => new (float.IsFinite(val.X) ? val.X : other.X,float.IsFinite(val.Y) ? val.Y : other.Y);

    public static Vector2 Abs(this Vector2 self) => new (System.Math.Abs(self.X), System.Math.Abs(self.Y));
    ...
    public static Vector4 ToNumericsVector(this Vec4<float> self) => new Vector4(self.X, self.Y, self.Z, self.W);
    
    public static Vector2 ToNumericsVector(this Vec2<float> self) => new Vector2(self.X, self.Y);
    
    public static Vector2 ToNumericsVector(this Vec2<double> self) => new Vector2((float)self.X, (float)self.Y);
    
    public static Vector2 ToNumericsVector(this Vec2<int> self) => new Vector2(self.X, self.Y);
