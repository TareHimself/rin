...
EXPORT void msdfGenerateMSDF(GlyphContext * context,float angleThreshold,float pixelRange,RenderMsdfCallback callback);

EXPORT void msdfGenerateMTSDF(GlyphContext * context,float angleThreshold,float pixelRange,RenderMsdfCallback callback);
