...
namespace TimSort
{
    ...
    internal class ByteArrayTimSort : TimSortBase<byte[], byte>
    {
        ...
        // redirection
        internal static void SortAll(byte[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(byte[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
	    ...
	    /// </param>
	    /// <returns>
	    ///     the int k,  0 &lt;= k &lt;= n such that a[b + k - 1] &lt; key &lt;= a[b + k], pretending that a[b - 1]
	    ...
	    /// <param name="length">the length of the range; must be &gt; 0.</param>
	    /// <param name="hint">
	    ///     the index at which to begin the search, 0 &lt;= hint &lt; n. The closer hint is to the result,
	    ///     the faster this method will run.
	    /// </param>
    ...
    internal class SByteArrayTimSort : TimSortBase<sbyte[], sbyte>
    {
        ...
        // redirection
        internal static void SortAll(sbyte[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(sbyte[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class Int16ArrayTimSort : TimSortBase<short[], short>
    {
	    /// <summary>
	    ...
	    /// </summary>
	    /// <param name="array">The array to be sorted.</param>
	    private Int16ArrayTimSort(short[] array)
            : base(array, array.Length)
        {
        }
        ...
        // redirection
        internal static void SortAll(short[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(short[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
		...
		unsafe
#endif
        private static void BinarySort(short[] array, int lo, int hi, int start)
        {
#if UNSAFE
		...
		unsafe
#endif
        private static int CountRunAndMakeAscending(short[] array, int lo, int hi)
        {
#if UNSAFE
			fixed (Int16 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopLeft(short key, short[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (Int16 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopRight(short key, short[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (Int16 * a = &array[0])
#else
    ...
    internal class UInt16ArrayTimSort : TimSortBase<ushort[], ushort>
    {
	    /// <summary>
	    ...
	    /// </summary>
	    /// <param name="array">The array to be sorted.</param>
	    private UInt16ArrayTimSort(ushort[] array)
            : base(array, array.Length)
        {
        }
        ...
        // redirection
        internal static void SortAll(ushort[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(ushort[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
        ...
        /// <param name="lo">the index of the first element in the range to be sorted.</param>
        /// <param name="hi">the index after the last element in the range to be sorted.</param>
        public static void Sort(ushort[] array, int lo, int hi)
        {
            CheckRange(array.Length, lo, hi);
		...
		unsafe
#endif
        private static void BinarySort(ushort[] array, int lo, int hi, int start)
        {
#if UNSAFE
		...
		unsafe
#endif
        private static int CountRunAndMakeAscending(ushort[] array, int lo, int hi)
        {
#if UNSAFE
			fixed (UInt16 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopLeft(ushort key, ushort[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (UInt16 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopRight(ushort key, ushort[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (UInt16 * a = &array[0])
#else
    ...
    internal class Int32ArrayTimSort : TimSortBase<int[], int>
    {
	    /// <summary>
	    ...
	    /// </summary>
	    /// <param name="array">The array to be sorted.</param>
	    private Int32ArrayTimSort(int[] array)
            : base(array, array.Length)
        {
        }
        ...
        // redirection
        internal static void SortAll(int[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(int[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
		...
		unsafe
#endif
        private static void BinarySort(int[] array, int lo, int hi, int start)
        {
#if UNSAFE
		...
		unsafe
#endif
        internal static int GallopLeft(int key, int[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (Int32 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopRight(int key, int[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (Int32 * a = &array[0])
#else
    ...
    internal class UInt32ArrayTimSort : TimSortBase<uint[], uint>
    {
	    /// <summary>
	    ...
	    /// </summary>
	    /// <param name="array">The array to be sorted.</param>
	    private UInt32ArrayTimSort(uint[] array)
            : base(array, array.Length)
        {
        }
        ...
        // redirection
        internal static void SortAll(uint[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(uint[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
        ...
        /// <param name="lo">the index of the first element in the range to be sorted.</param>
        /// <param name="hi">the index after the last element in the range to be sorted.</param>
        public static void Sort(uint[] array, int lo, int hi)
        {
            CheckRange(array.Length, lo, hi);
		...
		unsafe
#endif
        private static void BinarySort(uint[] array, int lo, int hi, int start)
        {
#if UNSAFE
		...
		unsafe
#endif
        private static int CountRunAndMakeAscending(uint[] array, int lo, int hi)
        {
#if UNSAFE
			fixed (UInt32 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopLeft(uint key, uint[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (UInt32 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopRight(uint key, uint[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (UInt32 * a = &array[0])
#else
    ...
    internal class Int64ArrayTimSort : TimSortBase<long[], long>
    {
	    /// <summary>
	    ...
	    /// </summary>
	    /// <param name="array">The array to be sorted.</param>
	    private Int64ArrayTimSort(long[] array)
            : base(array, array.Length)
        {
        }
        ...
        // redirection
        internal static void SortAll(long[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(long[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
		...
		unsafe
#endif
        private static void BinarySort(long[] array, int lo, int hi, int start)
        {
#if UNSAFE
		...
		unsafe
#endif
        private static int CountRunAndMakeAscending(long[] array, int lo, int hi)
        {
#if UNSAFE
			fixed (Int64 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopLeft(long key, long[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (Int64 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopRight(long key, long[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (Int64 * a = &array[0])
#else
    ...
    internal class UInt64ArrayTimSort : TimSortBase<ulong[], ulong>
    {
	    /// <summary>
	    ...
	    /// </summary>
	    /// <param name="array">The array to be sorted.</param>
	    private UInt64ArrayTimSort(ulong[] array)
            : base(array, array.Length)
        {
        }
        ...
        // redirection
        internal static void SortAll(ulong[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(ulong[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
        ...
        /// <param name="lo">the index of the first element in the range to be sorted.</param>
        /// <param name="hi">the index after the last element in the range to be sorted.</param>
        public static void Sort(ulong[] array, int lo, int hi)
        {
            CheckRange(array.Length, lo, hi);
		...
		unsafe
#endif
        private static void BinarySort(ulong[] array, int lo, int hi, int start)
        {
#if UNSAFE
		...
		unsafe
#endif
        private static int CountRunAndMakeAscending(ulong[] array, int lo, int hi)
        {
#if UNSAFE
			fixed (UInt64 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopLeft(ulong key, ulong[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (UInt64 * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopRight(ulong key, ulong[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (UInt64 * a = &array[0])
#else
    ...
    internal class SingleArrayTimSort : TimSortBase<float[], float>
    {
	    /// <summary>
	    ...
	    /// </summary>
	    /// <param name="array">The array to be sorted.</param>
	    private SingleArrayTimSort(float[] array)
            : base(array, array.Length)
        {
        }
        ...
        // redirection
        internal static void SortAll(float[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(float[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
		...
		unsafe
#endif
        private static void BinarySort(float[] array, int lo, int hi, int start)
        {
#if UNSAFE
		...
		unsafe
#endif
        private static int CountRunAndMakeAscending(float[] array, int lo, int hi)
        {
#if UNSAFE
			fixed (Single * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopLeft(float key, float[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (Single * a = &array[0])
#else
		...
		unsafe
#endif
        internal static int GallopRight(float key, float[] array, int lo, int length, int hint)
        {
#if UNSAFE
			fixed (Single * a = &array[0])
#else
    ...
    internal class DoubleArrayTimSort : TimSortBase<double[], double>
    {
        ...
        // redirection
        internal static void SortAll(double[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(double[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class DecimalArrayTimSort : TimSortBase<decimal[], decimal>
    {
        ...
        // redirection
        internal static void SortAll(decimal[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(decimal[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class CharArrayTimSort : TimSortBase<char[], char>
    {
        ...
        // redirection
        internal static void SortAll(char[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(char[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class DateTimeArrayTimSort : TimSortBase<DateTime[], DateTime>
    {
        ...
        // redirection
        internal static void SortAll(DateTime[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(DateTime[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class TimeSpanArrayTimSort : TimSortBase<TimeSpan[], TimeSpan>
    {
        ...
        // redirection
        internal static void SortAll(TimeSpan[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(TimeSpan[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class GuidArrayTimSort : TimSortBase<Guid[], Guid>
    {
        ...
        // redirection
        internal static void SortAll(Guid[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(Guid[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
        ...
        internal static int GallopLeft(Guid key, Guid[] array, int lo, int length, int hint)
        {
...
#endif
            {
                ...
                if (key.CompareTo(a[lo + hint]) > 0) // comparer(key, a[lo + hint]) > 0
                {
                    ...
                    var maxOfs = length - hint;
                    while (ofs < maxOfs &&
                           key.CompareTo(a[lo + hint + ofs]) > 0) // comparer(key, a[lo + hint + ofs]) > 0
                    {
                        lastOfs = ofs;
                        ofs = (ofs << 1) + 1;
                        if (ofs <= 0) // int overflow
        ...
        internal static int GallopLeft(T key, T[] array, int lo, int length, int hint, Comparison<T> comparer)
        {
            var a = array;
            {
                ...
                if (comparer(key, a[lo + hint]) > 0) // comparer(key, a[lo + hint]) > 0
                {
                    ...
                    var maxOfs = length - hint;
                    while (ofs < maxOfs &&
                           comparer(key, a[lo + hint + ofs]) > 0) // comparer(key, a[lo + hint + ofs]) > 0
                    {
                        lastOfs = ofs;
                        ofs = (ofs << 1) + 1;
                        if (ofs <= 0) // int overflow
            ...
            var a = array;
            {
                ...
                while (true)
                {
                    ...
                    do
                    {
                        ...
                        count2 = len2 -
                                 AnyArrayTimSort<T>.GallopLeft(a[cursor1], mergeBuffer, 0, len2, len2 - 1, comparer);
                        if (count2 != 0)
                        {
                            dest -= count2;
                            cursor2 -= count2;
    ...
    internal class ComparableArrayTimSort<T> : TimSortBase<T[], T> where T : IComparable<T>
    {
        ...
        // redirection
        internal static void SortAll(T[] array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(T[] array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
    ...
    internal class ComparableListTimSort<T> : TimSortBase<List<T>, T> where T : IComparable<T>
    {
        ...
        // redirection
        internal static void SortAll(List<T> array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(List<T> array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
            ...
            var a = array;
            {
                ...
                while (true)
                {
                    ...
                    do
                    {
                        ...
                        count2 = len2 -
                                 ComparableArrayTimSort<T>.GallopLeft(a[cursor1], mergeBuffer, 0, len2, len2 - 1);
                        if (count2 != 0)
                        {
                            dest -= count2;
                            cursor2 -= count2;
    ...
    internal class ComparableIListTimSort<T> : TimSortBase<IList<T>, T> where T : IComparable<T>
    {
        ...
        // redirection
        internal static void SortAll(IList<T> array)
        {
            Sort(array);
        }

        // redirection
        internal static void SortRange(IList<T> array, int lo, int hi)
        {
            Sort(array, lo, hi);
        }
