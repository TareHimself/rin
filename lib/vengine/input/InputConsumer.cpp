...
// bool InputConsumer::ReceiveMouseDown(const window::EMouseButton &button,
//                                      const std::shared_ptr<
//                                        window::MouseButtonEvent> &
//                                      event) {
//   if (_mouseHandlers->ForEach(
//       [event](const mouseHandlerPair &handlers) {
//         return handlers.second(event);
//       })) {
//     return true;
//   }
//
...
//
//     if (_mouseSpecificHandlers[button]->ForEach(
//         [event](const mouseHandlerPair &handlers) {
//           return handlers.second(event);
//         })) {
//       return true;
...
// }
//
// bool InputConsumer::ReceiveMouseUp(const window::EMouseButton &button,
//                                    const std::shared_ptr<
//                                      window::MouseButtonEvent> &
//                                    event) {
//   if (_mouseHandlers->ForEach(
//       [event](const mouseHandlerPair &handlers) {
//         return handlers.first(event);
//       })) {
//     return true;
//   }
//
