...
public class Fitter : Container
{
    ...
    public static Size2d ComputeContainSize(Size2d drawSize, Size2d widgetSize)
    {
        ...
        if (drawSize.Equals(scaledWidgetSize))
        {
            return scaledWidgetSize;
        }


        return scaledWidgetSize.Height <= drawSize.Height ? scaledWidgetSize : new Size2d(drawSize.Height / widgetAspect, drawSize.Height);
    }
    ...
    public static Size2d ComputeCoverSize(Size2d drawSize, Size2d widgetSize)
    {
        ...
        return scaledWidgetSize.Height <= drawSize.Height ? new Size2d(drawSize.Height / widgetAspect, drawSize.Height) : scaledWidgetSize;
    }
    public void SizeContent(Size2d drawSize)
    {
        ...
        var newDrawSize = widgetSize.Equals(drawSize) ? widgetSize : _fitFittingMode switch
        {
