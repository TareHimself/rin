...
{
    public static string GlobalBufferBinding = "ui";
    ...
    public WidgetSurface()
    {
        ...
        SimpleRectMat = new MaterialInstance(Path.Join(SWidgetsModule.ShadersDir,"simple_rect.ash"));
        SimpleRectMat.BindBuffer("ui", GlobalBuffer);
        RectClipMat = new MaterialInstance(Path.Join(SWidgetsModule.ShadersDir,"rect_clip.ash"));
    ...
    private void CreateImages()
    {
        ...
        var drawCreateInfo =
            SGraphicsModule.MakeImageCreateInfo(ImageFormat.Rgba32SFloat, new VkExtent3D
            {
                width = imageExtent.X,
    ...
    public virtual void BeginMainPass(WidgetFrame frame,bool clear = false)
    {
        ...
        cmd.BeginRendering(new VkExtent2D()
        {
            ...
            SGraphicsModule.MakeRenderingAttachment(GetDrawImage().View,
                VkImageLayout.VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL, clear
                    ? new VkClearValue
                    {
    ...
    public virtual void Draw(Frame frame)
    {
        ...
        _globalData.time = (float)SRuntime.Get().GetElapsedRuntimeTimeSeconds();
        ...
        foreach (var widgetCmd in widgetFrame.DrawCommandList)
           widgetCmd.Value.Run(widgetFrame);
    ...
    public virtual T Add<T>(T widget) where T : Widget
    {
        ...
        widget.NotifyAddedToSurface(this);
    ...
    public virtual bool Remove(Widget widget)
    {
        ...
        widget.NotifyRemovedFromSurface(this);
        return true;
    }
}