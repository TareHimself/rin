...
{
    return static_cast<Matrix3<T>>(glm::translate(static_cast<glm::mat<3, 3, T>>(*this),
                                                  static_cast<glm::vec<2, T>>(translation)));
}
...
{
    return static_cast<Matrix3<T>>(
        glm::scale(static_cast<glm::mat<3, 3, T>>(*this), static_cast<glm::vec<2, T>>(scale)));
}
