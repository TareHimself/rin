...
public:
    DeviceImage(VmaAllocator allocator, const vk::Image& image, VmaAllocation allocation, const vk::Extent3D& extent,
                ImageFormat format);
    ...
    void Barrier(vk::CommandBuffer cmd, vk::ImageLayout from, vk::ImageLayout to,
    ...
    void CopyTo(vk::CommandBuffer cmd, const vk::Image& dest, const vk::Extent3D& destExtent,
