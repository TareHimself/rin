...
public:
    ...
    Shared<DeviceBuffer> NewBuffer(vk::DeviceSize size, vk::BufferUsageFlags usageFlags,
                                   vk::MemoryPropertyFlags propertyFlags,
                                   bool sequentialWrite = true, bool preferHost = false, bool mapped = false,
    ...
    Shared<DeviceBuffer> NewTransferBuffer(vk::DeviceSize size, bool sequentialWrite = true,
                                           const std::string& debugName = "Transfer Buffer");

    Shared<DeviceBuffer> NewUniformBuffer(vk::DeviceSize size, bool sequentialWrite = true,
                                          const std::string& debugName = "Uniform Buffer");

    Shared<DeviceBuffer> NewStorageBuffer(vk::DeviceSize size, bool sequentialWrite = true,
                                          const std::string& debugName = "Storage Buffer");

    Shared<DeviceBuffer> NewResourceBuffer(const ShaderResource& resource, bool sequentialWrite = true,
                                           const std::string& debugName = {});

    template <typename T>
    Shared<DeviceBuffer> NewTransferBuffer(bool sequentialWrite = true,
                                           const std::string& debugName = "Transfer Buffer");
...
template <typename T>
Shared<DeviceBuffer> Allocator::NewBuffer(const vk::BufferUsageFlags usageFlags,
                                          const vk::MemoryPropertyFlags propertyFlags,
                                          const bool sequentialWrite, const bool preferHost, const bool mapped,
                                          const std::string& debugName)
{
