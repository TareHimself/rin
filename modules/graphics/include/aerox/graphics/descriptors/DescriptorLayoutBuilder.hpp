...
namespace aerox::graphics
{
    ...
    public:
        DescriptorLayoutBuilder& AddBinding(uint32_t binding,vk::DescriptorType type,const vk::ShaderStageFlags& stageFlags,uint32_t count = 1,const vk::DescriptorBindingFlags& flags = {});
