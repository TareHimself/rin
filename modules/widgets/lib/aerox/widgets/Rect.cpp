#pragma once
#include "aerox/widgets/Rect.hpp"

namespace aerox::widgets
{
    Rect::Rect(const Vec2<float>& inOffset, const Vec2<float>& inSize) : offset(inOffset), size(inSize)
    {

    }

    bool Rect::Contains(const Vec2<float>& point) const
    {
