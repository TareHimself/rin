...
WidgetPanelSlot::WidgetPanelSlot(WidgetPanel * panel,const Shared<Widget>& widget) : WidgetContainerSlot(widget)
{
    _panel = panel;
}

bool WidgetPanelSlot::NearlyEqual(double a, double b, double tolerance)
{
    return abs(a - b) < tolerance;
}

void WidgetPanelSlot::ComputeSizeAndOffset() const
{
