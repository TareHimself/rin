...
public static class EasingFunctions
{
    ...
    {
        return (float)System.Math.Pow(alpha - 1, 3) + 1;
    }
    ...
    {
        return (float)(1 - System.Math.Pow(alpha - 1, 4));
    }

    public static float EaseInOutQuart(float alpha)
    {
        return (float)(alpha < 0.5f ? 8 * alpha * alpha * alpha * alpha : 1 - 8 * System.Math.Pow(alpha - 1, 4));
    }
    ...
    {
        return (float)System.Math.Pow(alpha - 1, 5) + 1;
    }
    ...
    {
        return (float)(1 - System.Math.Cos(alpha * System.Math.PI / 2));
    }
    ...
    {
        return (float)(0.5f * (1 - System.Math.Cos(alpha * System.Math.PI)));
    }

    public static float EaseInExpo(float alpha)
    {
        return (float)(alpha == 0 ? 0 : System.Math.Pow(2, 10 * (alpha - 1)));
    }

    public static float EaseOutExpo(float alpha)
    {
        return (float)(System.Math.Abs(alpha - 1.0) < 0.001 ? 1 : 1 - System.Math.Pow(2, -10 * alpha));
    }
    ...
    {
        return (float)(1 - System.Math.Sqrt(1 - alpha * alpha));
    }

    public static float EaseOutCirc(float alpha)
    {
        return (float)System.Math.Sqrt(1 - System.Math.Pow(alpha - 1, 2));
    }
