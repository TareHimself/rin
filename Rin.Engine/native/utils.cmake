...
macro(FindSlang TARGET_PROJECT)
  ...
  if(NOT EXISTS ${SLANG_OUTPUT_DIR})
        ...
        elseif(LINUX) 
            file(DOWNLOAD https://github.com/shader-slang/slang/releases/download/v${SLANG_VERSION}/slang-${SLANG_VERSION}-linux-x86_64.zip ${DOWNLOADED_FILE} SHOW_PROGRESS)
            file(ARCHIVE_EXTRACT INPUT ${DOWNLOADED_FILE} DESTINATION ${SLANG_OUTPUT_DIR})
        elseif(APPLE)
