...
public class SlangSession : IDisposable
{
    ...
    public SlangModule? LoadModuleFromSourceString(string moduleName, string path, string content)
    {
        unsafe
        {
            ...
            var module = Native.slangSessionLoadModuleFromSourceString(_ptr, moduleName, path, content, null);
        ...
        SlangBlob outDiagnostics)
    {
        ...
        {
            var module =
                Native.slangSessionLoadModuleFromSourceString(_ptr, moduleName, path, content,
    ...
    public SlangComponent? CreateComposedProgram(SlangModule module, IEnumerable<SlangEntryPoint> entryPoints)
    {
        unsafe
        {
            ...
            var ptr = Native.slangSessionCreateComposedProgram(_ptr, module.ToPointer(), pEntryPoints,
                asArray.Length, null);
