    ...
    public ImageBarrierOptions(ImageFormat format, ImageLayout from, ImageLayout to)
    {
        switch (format)
        {
            ...
            case ImageFormat.Depth:
                SubresourceRange =
                    VulkanGraphicsModule.MakeImageSubresourceRange(VkImageAspectFlags.VK_IMAGE_ASPECT_DEPTH_BIT);
                break;
            case ImageFormat.Stencil:

                SubresourceRange = VulkanGraphicsModule.MakeImageSubresourceRange(
