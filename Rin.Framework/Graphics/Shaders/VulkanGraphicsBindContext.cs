    ...
    : VulkanBindContext<IGraphicsBindContext>(executionContext), IGraphicsBindContext
{
        ...
        uint commandsOffset = 0)
    {
        ...
        vkCmdDrawIndexedIndirect(ExecutionContext.CommandBuffer, commands.Buffer.NativeBuffer, commands.Offset,
            drawCount, stride);
        ...
        uint maxDrawCount, uint stride, uint commandsOffset = 0, uint drawCountOffset = 0)
    {
        ...
        vkCmdDrawIndexedIndirectCount(ExecutionContext.CommandBuffer, commands.Buffer.NativeBuffer, commands.Offset,
            drawCount.Buffer.NativeBuffer,
