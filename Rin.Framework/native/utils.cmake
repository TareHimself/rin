...
macro(DeriveDotnetRID RID_VARIABLE)
  string(TOLOWER "${CMAKE_SYSTEM_PROCESSOR}" _arch)
  if(WIN32)
    set(${RID_VARIABLE} "win")
  elseif(LINUX) 
    set(${RID_VARIABLE} "linux")
  elseif(APPLE)
    set(${RID_VARIABLE} "osx")
  endif()
  # if(WIN32)
  #   if(_arch STREQUAL "arm64")
  #     set(${RID_VARIABLE} "win-arm64")
  #   elseif(CMAKE_SIZEOF_VOID_P EQUAL 4)
  #     set(${RID_VARIABLE} "win-x86")
  #   else()
  #     set(${RID_VARIABLE} "win-x64")
  #   endif()
  # elseif(LINUX) 
  #   if(_arch STREQUAL "arm64")
  #     set(${RID_VARIABLE} "linux-arm64")
  #   else()
  #     set(${RID_VARIABLE} "linux-x64")
  #   endif()
  # elseif(APPLE)
  #   if(_arch STREQUAL "arm64")
  #     set(${RID_VARIABLE} "osx-arm64")
  #   else()
  #     set(${RID_VARIABLE} "osx-x64")
  #   endif()
  # endif()
endmacro()
