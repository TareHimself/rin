...
public sealed class SApplication
{
    ...
    [PublicAPI] public SourceResolver Sources = new()
    {
        ...
        [
            ...
            AssemblyContentResource.New<SApplication>("Framework")
        ]
    };
    ...
    public event Action<SApplication>? OnStartup;
    public event Action<SApplication>? OnShutdown;

    public static SApplication Get()
    {
        return _instance ??= new SApplication();
    }
