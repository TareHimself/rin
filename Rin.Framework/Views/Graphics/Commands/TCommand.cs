...
/// </summary>
public abstract class TCommand<TPassConfig, TCommandHandler> : ICommand where TPassConfig : IPassConfig, new()
    where TCommandHandler : ICommandHandler, new()
{
    ...
    {
        var passConfig = new TPassConfig();
        passConfig.Init(context);
        return passConfig;
    }
