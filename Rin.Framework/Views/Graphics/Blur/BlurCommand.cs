...
internal class BlurInitCommand : TCommand<BlurInitPassConfig, BlurInitCommandHandler>
{
    ...
    public BlurInitCommand(in Matrix4x4 transform, float strength, float radius, in Vector2 size,
        in Vector2 surfaceSize, in Vector4 tint)
    {
...
internal class BlurSecondPassCommand(BlurInitCommand initCommand)
    : TCommand<MainPassConfig, BlurSecondPassCommandHandler>
{
    public BlurInitCommand InitCommand = initCommand;
}
