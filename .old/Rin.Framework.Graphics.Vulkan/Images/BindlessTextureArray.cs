...
public class BindlessTextureArray : BindlessResource,IDisposableVulkanTextureArray
{
    public IDisposableVulkanTextureArray? Source { get; set; }
    ...
    public uint Count => Source?.Count ?? throw new NullReferenceException();
    public void Dispose()
    {
