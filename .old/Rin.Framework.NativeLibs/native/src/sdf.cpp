...
void sdfContextBeginContour(GlyphContext* context)
{
    if (context->contour != nullptr)
    {
        sdfContextEndContour(context);
    }
    context->contour = &context->shape.addContour();
}

void sdfContextEndContour(GlyphContext* context)
{
    if (context->contour != nullptr)
    {
        if (context->contour->edges.empty())
        {
...
{
    sdfContextBeginContour(context);
    context->position = *to;
}
...
void sdfContextFinish(GlyphContext * context)
{
    sdfContextEndContour(context);
