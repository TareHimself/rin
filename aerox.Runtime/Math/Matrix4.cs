...
public partial struct Matrix4 : ICloneable<Matrix4>, IMultiplyOperators<Matrix4,Matrix4,Matrix4>,IMultiplyOperators<Matrix4,Vector4<float>,Vector4<float>>
{
    ...
    public Matrix4 Clone() => new Matrix4()
    {
    ...
    [LibraryImport(Dlls.AeroxNative, EntryPoint = "mathInverseMatrix4")]
    ...
    [LibraryImport(Dlls.AeroxNative, EntryPoint = "mathTranslateMatrix4")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl) ])]
    ...
    [LibraryImport(Dlls.AeroxNative, EntryPoint = "mathScaleMatrix4")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl) ])]
    ...
    [LibraryImport(Dlls.AeroxNative, EntryPoint = "mathRotateMatrix4")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl) ])]
    private static partial void NativeRotate(ref Matrix4 result,ref Matrix4 target,float angle,ref Vector3<float> axis);
    ...
    [LibraryImport(Dlls.AeroxNative, EntryPoint = "mathMultiplyMatrix4Matrix4")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl) ])]
    ...
    [LibraryImport(Dlls.AeroxNative, EntryPoint = "mathMultiplyMatrix4Vector4")]
    [UnmanagedCallConv(CallConvs = [typeof(System.Runtime.CompilerServices.CallConvCdecl) ])]
    private static partial void NativeMultiplyMatrix4Vector4(ref Vector4<float> result,ref Matrix4 left,ref Vector4<float> right);
